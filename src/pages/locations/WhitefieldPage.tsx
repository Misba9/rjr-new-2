...
export default function WhitefieldPage({ onNavigate }: WhitefieldPageProps) {
  const pageUrl = canonicalUrl('whitefield');

  useEffect(() => {
    updatePageMeta({
      title: 'Safety Nets in Whitefield, Bangalore | Balcony & Bird Nets | RJR',
      description: 'Professional safety net installation in Whitefield. Balcony, pigeon/bird, children, construction nets. Free inspection, fast install, 5+ years warranty.',
      keywords: 'Safety Nets Whitefield, Balcony Safety Nets Whitefield, Pigeon Nets Whitefield, Bird Nets Whitefield',
      canonical: pageUrl,
      ogTitle: 'Safety Nets in Whitefield | RJR Safety Nets',
      ogDescription: 'Balcony, pigeon/bird, children & construction safety nets in Whitefield. Free inspection & quick installation.',
      ogType: 'website',
    ...
    <div className="min-h-screen">
      <section className="py-20 md:py-28 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">Safety Nets in Whitefield, Bangalore</h1>
            ...
            <p className="text-lg text-gray-700 mb-8">We serve apartments and villas across Whitefield, Kadugodi, Varthur, Hoodi, ITPL, and nearby localities with quick inspection and transparent pricing.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {['Balcony Safety Nets','Pigeon/Bird Nets','Children Safety Nets','Construction Safety Nets'].map((s, i) => (
              <div key={i} className="bg-gray-50 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700">Professional installation in Whitefield with warranty-backed materials and clean finishing.</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {onNavigate ? (
        <section className="border-t border-gray-100 bg-white py-10">
          <div className="mx-auto max-w-4xl px-4 text-center text-gray-700 sm:px-6 lg:px-8">
            <p className="mb-4 font-semibold text-gray-900">Explore services</p>
            <div className="flex flex-wrap justify-center gap-3">
              <button type="button" onClick={() => onNavigate('services')} className="text-blue-600 hover:underline">
                All services
              </button>
              <span className="text-gray-300">|</span>
              <button type="button" onClick={() => onNavigate('balcony')} className="text-blue-600 hover:underline">
                Balcony safety nets
              </button>
              <span className="text-gray-300">|</span>
              <button type="button" onClick={() => onNavigate('pigeon')} className="text-blue-600 hover:underline">
                Pigeon safety nets
              </button>
            </div>
          </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Free Inspection in Whitefield</h2>
