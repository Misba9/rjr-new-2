...
interface HSRLayoutPageProps {
  onNavigate?: (page: string) => void;
}

export default function HSRLayoutPage(_props: HSRLayoutPageProps) {
  useEffect(() => {
    updatePageMeta({
      title: 'Safety Nets in HSR Layout, Bangalore | Balcony & Bird Nets | RJR',
      description: 'Expert safety net installation in HSR Layout. Balcony, pigeon/bird, children, construction nets. Free inspection, fast install, 5+ years warranty.',
      keywords: 'Safety Nets HSR Layout, Balcony Safety Nets HSR, Pigeon Nets HSR',
      canonical: 'https://www.rjrsafetynets.in/hsr-layout',
      ogTitle: 'Safety Nets in HSR Layout | RJR Safety Nets',
      ogDescription: 'Balcony, pigeon/bird, children & construction safety nets in HSR Layout. Free inspection & quick installation.',
      ogType: 'website',
    ...
    addSchemaMarkup({
      ...
      '@type': 'Service',
      '@id': 'https://www.rjrsafetynets.in/hsr-layout#service',
    ...
    <div className="min-h-screen">
      <section className="py-20 md:py-28 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">Safety Nets in HSR Layout</h1>
            ...
            <p className="text-lg text-gray-700 mb-8">Serving HSR sectors 1–7, Agara, and Sarjapur Road. Quick inspection and transparent pricing.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {['Balcony Safety Nets','Pigeon/Bird Nets','Children Safety Nets','Construction Safety Nets'].map((s, i) => (
              <div key={i} className="bg-gray-50 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700">Professional installation in HSR with warranty-backed materials and clean finishing.</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Free Inspection in HSR Layout</h2>
