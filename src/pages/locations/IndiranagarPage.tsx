...
interface IndiranagarPageProps {
  onNavigate?: (page: string) => void;
}

export default function IndiranagarPage(_props: IndiranagarPageProps) {
  const pageUrl = canonicalUrl('indiranagar');

  useEffect(() => {
    updatePageMeta({
      title: 'Safety Nets in Indiranagar, Bangalore | Balcony & Bird Nets | RJR',
      description: 'Professional safety net installation in Indiranagar. Balcony, pigeon/bird, children, construction nets. Free inspection, fast install, 5+ years warranty.',
      keywords: 'Safety Nets Indiranagar, Balcony Safety Nets Indiranagar, Pigeon Nets Indiranagar',
      canonical: pageUrl,
      ogTitle: 'Safety Nets in Indiranagar | RJR Safety Nets',
      ogDescription: 'Balcony, pigeon/bird, children & construction safety nets in Indiranagar. Free inspection & quick installation.',
      ogType: 'website',
    ...
    <div className="min-h-screen">
      <section className="py-20 md:py-28 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">Safety Nets in Indiranagar</h1>
            ...
            <p className="text-lg text-gray-700 mb-8">Serving 80 Feet Road, CMH Road, Domlur, and nearby areas with quick inspection and transparent pricing.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {['Balcony Safety Nets','Pigeon/Bird Nets','Children Safety Nets','Construction Safety Nets'].map((s, i) => (
              <div key={i} className="bg-gray-50 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700">Professional installation in Indiranagar with warranty-backed materials and clean finishing.</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Free Inspection in Indiranagar</h2>
